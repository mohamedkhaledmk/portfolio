...
function WelcomeSection() {
  return (
    <div className=" bg-[url('/cover.jpg')]  bg-cover text-white h-screen mb-10 flex justify-center items-center flex-col  font-bold lg:text-4xl text-4xl space-y-2">
      ...
      <div>
        <Link
          href="https://www.youtube.com/watch?v=lmx-zIzThcI&feature=youtu.be&ab_channel=mohamedkhaled"
          target="_blank"
